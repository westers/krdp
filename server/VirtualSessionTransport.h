...
private:
    ...
    struct PendingPreview {
        ...
        QString outputId;
        QString backendKey;
        RemoteTopologyDraft::Operation::Kind kind = RemoteTopologyDraft::Operation::Kind::Move;
        QPoint position;
        QSize pixels;
        qreal scale = 1.0;
    ...
    quint64 m_addBinding = 0;
    QString m_addGeneration;
    quint64 m_addRevision = 0;
    QString m_addBackendKey;
    QVector<RemoteTopologyCatalog::Entry> m_addBefore;
    RemoteTopologyCatalog::Output m_addExpected;
    QString m_removeId;
    quint64 m_nextRemoveId = 0;
    quint64 m_removeWorkerId = 0;
    quint64 m_removeBinding = 0;
    QString m_removeGeneration;
    ...
    QString m_topologyResizeBackendKey;
    ...
    bool m_topologyMixedCreatePending = false;
